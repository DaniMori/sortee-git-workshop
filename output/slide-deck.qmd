...
institute:   |
  <table>
    <tr>
      ...
      <td>
        <right>
          [![](../www/UQlogo.png){height="75"}](https://www.uq.edu.au/)
        </right>
      </td>
    </tr>
  </table>
...
<!-- TODO: Host version and create bit.ly short link -->

-   <https://unedo365-my.sharepoint.com/:u:/g/personal/dvmorillo_psi_uned_es/EZBXy-Z5U75FsCKM_P0lTTkBzx3eH0IkrczYzmpPiCX31g?e=4ko0WX>

#### Technical assistance procedure

-   If you get stuck, copy and paste the error message to the chat (and chances
    are someone else is also getting the same error!)

<br>

-   The tech help (Kevin) will try to help you resolve it over chat

<br>

-   We will use the raise hand feature (or similar) to see if everyone is ready
    to move on from each exercise as we go

<br>

-   As a last resort, we can move to a private breakout room to discuss and try
...
::: nonincremental
1.  **In your GitHub repo**, return to the "Code" tab and click on the green
    "Code" button

2.  Click the "HTTPS" option and copy the "https://..." address
...
::: nonincremental
-   Download <!-- TODO: Create bit.ly short link -->
    <https://github.com/DaniMori/sortee-git-workshop/blob/feature/content-update/src/Analysis.R>
...
::: nonincremental
-   Download <!-- TODO: Create bit.ly short link -->
    <https://github.com/DaniMori/sortee-git-workshop/blob/feature/content-update/dat/penguins.csv>
