...
#### \<SECTION\>: <!-- TODO: Split rooms comment? -->
...
::: fragment
-   Change the file path in line 15 of "src/Analysis.R" to point to the dataset:
...
::: fragment
::: callout-note
You can check *absolute paths* w. `normalizePath()`:
...
::: aside
::: fragment
\* Even exceptions to (3) (and maybe (2)), but **never** (1)
:::
:::
